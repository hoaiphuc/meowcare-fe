...
import { Button, Input, Modal, ModalBody, ModalContent, ModalFooter, ModalHeader, Pagination, Table, TableBody, TableCell, TableColumn, TableHeader, TableRow, useDisclosure } from '@nextui-org/react';
...
const Page = () => {
    ...
    const handleUpdateService = () => {
        try {
            axiosClient.put(`config-services/${updateService.id}`, updateService)
                .then(() => {
                    fetchService()
