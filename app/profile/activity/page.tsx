...
const Page = () => {
  ...
  useEffect(() => {
    setIsLoading(true);
    axiosClient(
      `booking-orders/user/pagination?id=${userId}&page=${page}&size=5&sort=createdAt&direction=DESC`
    )
      .then((res) => {
        setData(res.data);
      ...
      <div className="ml-20 w-full gap-5 flex flex-col">
        ...
        <div className="flex gap-3">
          <Button
            className={`${styles.button} ${
              filterStatus === "ALL" ? styles.activeButton : ""
            }`}
          ...
          <Button
            className={`${styles.button} ${
              filterStatus === "CONFIRMED" ? styles.activeButton : ""
            }`}
          ...
          <Button
            className={`${styles.button} ${
              filterStatus === "IN_PROGRESS" ? styles.activeButton : ""
            }`}
          ...
          <Button
            className={`${styles.button} ${
              filterStatus === "COMPLETED" ? styles.activeButton : ""
            }`}
          ...
          <Button
            className={`${styles.button} ${
              filterStatus === "CANCELLED" ? styles.activeButton : ""
            }`}
        ...
        {isLoading ? (
          ...
          <div className="">
              ...
              data.content
                ...
                {isLoading ? (
                  ...
                  return (
                    <div
                      key={activity.id}
                      className="border w-[700px] p-3 rounded-lg flex justify-between my-3"
                    >
                      <div>
                        <div className="flex">
                          <Icon
                          ...
                          <div>
                            ...
                            <h2>
                              ...
                              {
                                activity.bookingDetailWithPetAndServices[0].pet
                                  .petName
                              }
                            </h2>
                        ...
                        <Button
                          as={Link}
                          href={`/profile/activity/detail/${activity.id}`}
            ...
            {page ? (
              <div
                className={pages <= 1 ? "hidden" : "flex w-full justify-center"}
              >
                <Pagination
                  isCompact
                  showControls
