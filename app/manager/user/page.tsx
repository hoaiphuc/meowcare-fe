                                            ...
                                            <div className='p-5'>
                                                ...
                                                <div className='my-5'>
                                                    <div className='flex'>
                                                        ...
                                                        <p className={styles.description}>{selectedUser.phoneNumber ? selectedUser.phoneNumber : "Không có"}</p>
                                                    </div>
                                                    <div className='flex'>
                                                    ...
                                                    <div className='flex flex-col mt-5'>
                                                        <div className='flex flex-col gap-3'>
                                                            {selectedUser.roles.map((role) => (
                                                                <Button key={role.id} className='w-full text-green-500 bg-white'>
                                                                    <FontAwesomeIcon icon={faCircle} /> {namesLables[role.roleName]}
                                                                </Button>
                                                            ))}
                                                            <Button className='bg-red-500 text-white' onClick={handleInactive}>khóa tài khoản này</Button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
